        ...
        >
          ...
          >
            ...
            <div className="space-y-4 px-5 py-5">
              ...
              {id ? (
                <div className="rounded-md border border-command-watch/35 bg-command-watch/10 px-3 py-3">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded border border-command-watch/40 px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.12em] text-command-watch transition hover:bg-command-watch/15"
                    >
                      {copied ? 'Copied' : 'Copy'}
                    </button>
                  </div>
              ...
              {canExportExcel ? (
                <button
                  ...
                  disabled={exporting}
                  className="flex w-full items-center justify-center rounded-md border border-[#e8a838] bg-[#e8a838] px-3 py-2.5 font-mono text-[11px] font-semibold uppercase tracking-[0.1em] text-[#141414] transition hover:bg-[#f0b54a] disabled:opacity-50"
                >
